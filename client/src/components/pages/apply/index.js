                        ...
                        <form onSubmit={this._handleSubmit} className="application-form" action="" method="post">
                            ...
                            <section className="contact-details-section">
                                ...
                                <div className="required">
                                    ...
                                    <input type="tel" name="tel" id="tel" placeholder="Your Phone" aria-required={true}
                                           required/>
                                </div>
                                {/* /phone */}
                            ...
                            <section className="course-selection-section">
                                ...
                                <fieldset className="course-selection" aria-required={true}>
                                    <div>
                                        <input type="radio" name="course" value="immersive" id="immersive" required/>
                                    ...
                                    <div>
                                        <input type="radio" name="course" value="javascript" id="javascript" required/>
                            ...
                            <section className="tech-background-section">
                                ...
                                <label htmlFor="tech-background">What is your current level of technical knowledge:<span
                                    className="required">*</span></label>
                            ...
                            <section className="goals-section">
                                ...
                                <fieldset className="hopes">
                                    ...
                                    <div>
                                        <input type="checkbox" name="hope" value="start-company" id="start-company"/>
                            ...
                            <section className="about-section">
                                ...
                                <label htmlFor="message">Is there anything else you would like to share with us?</label>
